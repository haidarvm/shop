			...
			<section class="col-lg-7 connectedSortable">
					...
					<div class="box-body">
						<form action="#" class="form-horizontal" method="post">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input id="name" name="price" class="form-control" type="text" placeholder="Rp">
								</div>
							</div>
							<div class="form-group">
				...
				<div class="box box-success">
					...
					<div class="box-body chat" id="chat-box">
						<!-- chat item -->
						<div class="item">
							<img src="<?php echo base_url();?>assets/img/user4-128x128.jpg"
						...
						<!-- chat item -->
						<div class="item">
							<img src="<?php echo base_url();?>assets/img/user3-128x128.jpg"
