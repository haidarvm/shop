...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			Create Product <small>it all starts here</small>
		</h1>
		<ol class="breadcrumb">
	...
	<section class="content">
		...
		<div class="row">
			<div class="box box-info" id="quick-product-box">
				...
				<div class="box-body">
					<form action="#" class="form-horizontal" id="quick-product"
						method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input id="name" name="price" class="form-control numbers"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input id="name" name="stock" class="form-control number"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<span class="btn btn-success fileinput-button"> <i
									...
									<input id="fileupload" type="file" name="userfile" multiple> <input
									type="hidden" name="product_id" id="product_id"
									value="<?php echo !empty($productDraft) ? $productDraft->product_id : "";?>">
									<input type="hidden" name="image_id" id="image_id"
									value="<?php echo !empty($productImgDraft) ? $productImgDraft->image_id : "";?>">
								</span>
							</div>
						</div>
						<div class="form-group">
