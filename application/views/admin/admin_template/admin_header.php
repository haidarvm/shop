	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index2.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				...
				<span class="logo-lg"><i class="fa fa-shopping-cart"></i> <b>Admin</b>Jackston</span>
			</a>
							...
							<ul class="dropdown-menu">
								...
								<li>
									...
									<ul class="menu">
										...
										<li><a href="#">
												<div class="pull-left">
													<img src="<?php echo base_url();?>assets/img/user3-128x128.jpg" class="img-circle"
														alt="User Image">
												</div>
												<h4>
										...
										<li><a href="#">
												<div class="pull-left">
													<img src="<?php echo base_url();?>assets/img/user4-128x128.jpg" class="img-circle"
														alt="User Image">
												</div>
												<h4>
